...
echo #define VERSION_STRING L"%VERSION_MAJOR%.%VERSION_MINOR%.%VERSION_BGFIX%" "-tesuri"
echo #define VERSION_NUMSTRING L"%VERSION_NUM%"
echo #define BUILDDATE_STRING L"%DATE%"
echo #define COPYRIGHT_STRING L"Copyright (C) 2005-2019 tesuri, Kazuo Ishii and ckw-mod creators and more..."
